...
<body>
    ...
    <div class="container">
        ...
        <form action="users_table.php" method="POST"  onsubmit="return confirmInsert();">
            ...
            <a href="home.php" class="btn btn-secondary" style="margin-left: 100px;">Back Home</a>
        </form>
    </div>
    <footer class="text-center mt-5"><!-- Footer section -->
        <p>&copy; &reg; 2024 UR CBE BIT YEAR 2 WEB TECHNOLOGY @ Group A</p><!-- Copyright and trademark notice -->
